...
Partial Public Class StudentsDataSet
    ...
    Partial Public Class studentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddstudentRow(ByVal name As String, ByVal username As String, ByVal mobile As String, ByVal email As String, ByVal password As String) As studentRow
            Dim rowstudentRow As studentRow = CType(Me.NewRow,studentRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, name, username, mobile, email, password}
    ...
    Partial Public Class studentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[student] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 A"& _ 
                "ND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_username = 1 AND "& _ 
                "[username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_mobile ="& _ 
                " 1 AND [mobile] IS NULL) OR ([mobile] = @Original_mobile)) AND ((@IsNull_email ="& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([name], [username], [mobile], [email], [password]) V"& _ 
                "ALUES (@name, @username, @mobile, @email, @password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, name, username"& _ 
                ", mobile, email, password FROM student WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[student] SET [name] = @name, [username] = @username, [mobile] = @mo"& _ 
                "bile, [email] = @email, [password] = @password WHERE (([Id] = @Original_Id) AND "& _ 
                ...
                "D ((@IsNull_mobile = 1 AND [mobile] IS NULL) OR ([mobile] = @Original_mobile)) A"& _ 
                ...
                "rd)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, name, username, mobile, email, password FROM student WHERE (I"& _ 
                "d = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.foodNation.My.MySettings.Default.StudentsConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, name, username, mobile, email, password FROM dbo.student"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As StudentsDataSet.studentDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As StudentsDataSet.studentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As StudentsDataSet.studentDataTable = New StudentsDataSet.studentDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As StudentsDataSet.studentDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_username As String, ByVal Original_mobile As String, ByVal Original_email As String, ByVal Original_password As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal name As String, ByVal username As String, ByVal mobile As String, ByVal email As String, ByVal password As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal name As String, ByVal username As String, ByVal mobile As String, ByVal email As String, ByVal password As String, ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_username As String, ByVal Original_mobile As String, ByVal Original_email As String, ByVal Original_password As String, ByVal Id As Integer) As Integer
            If (name Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal username As String, ByVal mobile As String, ByVal email As String, ByVal password As String, ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_username As String, ByVal Original_mobile As String, ByVal Original_email As String, ByVal Original_password As String) As Integer
            Return Me.Update(name, username, mobile, email, password, Original_Id, Original_name, Original_username, Original_mobile, Original_email, Original_password, Original_Id)
        End Function
    End Class
